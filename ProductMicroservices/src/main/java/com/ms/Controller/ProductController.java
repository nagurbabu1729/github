...
public class ProductController {
	...
	public ResponseEntity<?> addProduct(@RequestBody ProductRequest pr) {
		
		logger.info("product-api entered");
		
		ProductResponse products = productservice.addProduct(pr);
	...
	public ResponseEntity<ProductResponse> getProductById(@PathVariable Long id) {
		...
		logger.info("produt-get api entered");
